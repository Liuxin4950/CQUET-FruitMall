...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="form-product-edit">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input name="oneCategoryId" class="form-control" value="${product.oneCategoryId}" type="number">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">二级分类ID：</label>
            <div class="col-sm-8">
                <input name="twoCategoryId" class="form-control" value="${product.twoCategoryId}" type="number">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label is-required">价格：</label>
            <div class="col-sm-8">
                <input name="price" class="form-control" value="${product.price}" type="number" step="0.01" min="0" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">折扣价：</label>
            <div class="col-sm-8">
                <input name="discountPrice" class="form-control" value="${product.discountPrice}" type="number" step="0.01" min="0">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">库存：</label>
            <div class="col-sm-8">
                <input name="stock" class="form-control" value="${product.stock}" type="number" min="0">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">商品图片URL：</label>
            <div class="col-sm-8">
                <input name="imageUrl" class="form-control" value="${product.imageUrl}" type="url" placeholder="请输入图片链接地址">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select name="publishStatus" class="form-control">
                    <option value="0" ${product.publishStatus == 0 ? 'selected' : ''}>未发布</option>
                    <option value="1" ${product.publishStatus == 1 ? 'selected' : ''}>已发布</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select name="isOrganic" class="form-control">
                    <option value="0" ${product.isOrganic == false ? 'selected' : ''}>否</option>
                    <option value="1" ${product.isOrganic == true ? 'selected' : ''}>是</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input name="originPlace" class="form-control" value="${product.originPlace}" type="text">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">生产日期：</label>
            <div class="col-sm-8">
                <input name="productionDate" class="form-control" value="${product.productionDate}" type="text" placeholder="yyyy-MM-dd HH:mm:ss">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">保质期（天）：</label>
            <div class="col-sm-8">
                <input name="shelfLife" class="form-control" value="${product.shelfLife}" type="number" min="0">
            </div>
        </div>
        <div class="form-group">
