...
public interface OrderCartDao {
     ...
     * @return 购物车集合信息
     */
    List<OrderCart> selectOrderCartList(OrderCart orderCart) throws Exception;
     ...
     * @return 购物车对象信息
     */
    OrderCart selectOrderCartById(Integer cartId) throws Exception;
     ...
     * @return 结果
     */
    int updateOrderCart(Integer cartId, OrderCart orderCart);
     ...
     * @return 结果
     */
    int updateOrderCartSelectedByUserId(Integer userId, Boolean isSelected);
