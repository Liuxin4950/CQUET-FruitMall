...
import org.example.emarketmall.service.UserInfoService;
import org.example.emarketmall.service.impl.UserInfoServiceImpl;
...
public class UserInfoController extends HttpServlet {
    ...
    private void doProcessRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (referer.contains("index")) {
            resp.sendRedirect("/admin/user/user.jsp");
            return;
        }
        ...
        switch (opt) {
            case "add":
                ...
                if ("GET".equalsIgnoreCase(req.getMethod())) {
                    resp.sendRedirect("/admin/user/add.jsp");
                    return;
                }
